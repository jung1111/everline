    ...
    <div className="BannerSlider-container" {...handlers}>
      <div className="BannerSlider-wrap">
        <div className="BannerSlider-content">
          ...
          <div className="BannerSlider-button">
            <button onClick={goToPrevBanner} className="btn-prev"></button>
          </div>
          {banners.length > 0 && (
            <h3>
              <h6>OFFICIAL MD</h6>
          ...
          <div className="BannerSlider-button">
            <button onClick={goToNextBanner} className="btn-next"></button>
          </div>
          <div className="currentBanner-right">{`0${
            ((currentBanner + 1) % banners.length) + 1
          }`}</div>
        </div>
      </div>
