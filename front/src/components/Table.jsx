...
export default function Table({name, currentPage, pageSize, handleChange, listPage }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://localhost:3000/data/${name}.json`);
		...
		<div className='count'>
			...
			<div className='Board'>
					...
					<div className='search'>
						...
						/>
						<button type='button' className='search-btn' onClick={handleSearch} >검색</button>
